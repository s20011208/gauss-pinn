...
def train(rank, world_size, config):
    ...
    def train_with_lbfgs(f, ddp_g, cfg, dataset, heat: HeatEquation, initial_lr=1.0, max_iter=20000):
    ...
    for i in range(cfg.train.iteration):
        ...
        if rank==0 and (i+1)%cfg.train.iteration==0:
            ...
            train_with_lbfgs(f, ddp_g, cfg, dataset, heat, initial_lr=1.0, max_iter=20000)
